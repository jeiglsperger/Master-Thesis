...
def load_datasets():
    ...
    :return: raw dataset
    """
    dataset_raw = pd.read_csv("/Josef/DTW/time_series_augmentation/Data/Schachtschneider_externals_cut.csv", sep=',', decimal='.')
...
def real_data_loading(database_name, *shift_numbers):
    ...
    dataset_test.to_csv('/Josef/DTW/time_series_augmentation/test_data_schachtschneider.csv', index=False)
