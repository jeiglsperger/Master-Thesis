...
def test_samples(database_name, print_data=False):
    ...
    test, fake = load_data('test_data_Public_QuarterlyTouristsIndia.csv', 'fake_data_' + database_name + '.csv')
    ...
    try:
        table_evaluator.evaluate(target_col='TouristsIndia', target_type='regr')
    except:
        pass
