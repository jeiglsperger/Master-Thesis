...
from own_data_loading_TouristsIndia import real_data_loading, preprocess_data, cut_data
...
def objective(trial, dataset_train, dataset_val, num_samples, columns, database_name, seq_len, *shift_numbers):
    """
...
def run_TimeGAN(seq_len, num_samples, n_trials, database_name, *shift_numbers):
    ...
    study.optimize(lambda trial: objective(trial, dataset_train, dataset_val, num_samples, columns, database_name, seq_len, *shift_numbers), n_trials)
    ...
    # postprocessing
    fake_data = postprocess_data("eval", generated_data, columns, seq_len, *shift_numbers)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-seq_len", "--seq_len", type=int, default=21, help="specify the generated sequence length")
