...
from utils.data_loader_MonthlyMilkProduction import real_data_loading, postprocess_data
...
def run_DTW(n_trials=50, database_name="default", *shift_numbers):
    ...
    study.optimize(lambda trial: objective(trial, x_train, y_train, columns, dataset_val, database_name, *shift_numbers),
                   n_trials)
